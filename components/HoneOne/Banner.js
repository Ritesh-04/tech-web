    ...
    render() {
        return (
            <div className="banner-section">
                            ...
                            <div className="row">
                                <div className="col-lg-7 col-md-12">
                                    <div className="banner-content">
                                        ...
                                        <p>Techman solution recruit and retain the highest calibre of experienced employees with proven ability of providing customer service excellence at all times..</p>
                                        <form>
                ...
                <div className="shape-img2"><img src={require("../../images/shape/2.svg")} alt="image" /></div>
                <div className="shape-img4"><img src={require("../../images/shape/4.png")} alt="image" /></div>
                <div className="shape-img7"><img src={require("../../images/shape/7.png")} alt="image" /></div>
